<template>
  ...
  <div>
    <form id="burger-form" method="POST" @submit="createBurger">
      ...
      <div class="input-container">
        <label for="carne">Choose hamburger meat:</label>
        <select name="carne" id="carne" v-model="carne" required>
          <option value="">Select the hamburger meat</option>
...
export default {
  ...
  methods: {
    ...
    async createBurger(e) {
      ...
      this.msg = `Order No.  ${res.id} performed successfully`;

      // clear message
      setTimeout(() => (this.msg = ""), 2300);
